        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
              Discover the latest insights, tutorials, and thoughts on modern web development. 
              From React and Next.js to cutting-edge technologies shaping the future of the web.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
              <div className="flex flex-col items-center p-6 bg-card rounded-xl border shadow-sm">
                ...
                <p className="mt-2 text-sm text-muted-foreground text-center">
                  Stay updated with the newest frameworks, tools, and best practices
                </p>
              </div>
              ...
              <div className="flex flex-col items-center p-6 bg-card rounded-xl border shadow-sm">
                ...
                <h3 className="mt-4 text-lg font-semibold">In-Depth Tutorials</h3>
                <p className="mt-2 text-sm text-muted-foreground text-center">
